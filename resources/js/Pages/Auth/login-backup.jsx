...
function LoginForm({ status, canResetPassword, recaptchaSiteKey }) {
...
export default function Login({ status, canResetPassword, recaptchaSiteKey }) {
    return (
        <GoogleReCaptchaProvider reCaptchaKey={recaptchaSiteKey}>
            <LoginForm status={status} canResetPassword={canResetPassword} recaptchaSiteKey={recaptchaSiteKey} />
