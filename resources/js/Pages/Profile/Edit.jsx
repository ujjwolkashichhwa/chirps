...
export default function Edit({ auth, mustVerifyEmail, status }) {
    const items = [
        { id: '1', component: <UpdateProfileInformationForm mustVerifyEmail={mustVerifyEmail} status={status} className="max-w-xl" /> },
        { id: '2', component: <UpdatePasswordForm className="max-w-xl" /> },
        { id: '3', component: <DeleteUserForm className="max-w-xl" /> }
    ]
