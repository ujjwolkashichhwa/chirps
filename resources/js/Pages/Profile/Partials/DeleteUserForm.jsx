                ...
                >
                    ...
                    <div className="mt-6">
                        ...
                        <TextInput
                            ...
                            className="mt-1 block w-3/4 no-drag"
                            isFocused
                    ...
                    <div className="mt-6 flex justify-end">
                        <SecondaryButton onClick={closeModal} className='no-drag'>Cancel</SecondaryButton>

                        <DangerButton className="ms-3 no-drag" disabled={processing}>
                            Delete Account
                        </DangerButton>
                    </div>
                </Recaptcha>
