            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    ...
                    {chirp.user.id === auth.user.id &&
                        <Dropdown>
                            <Dropdown.Trigger>
                                <button className="no-drag" style={{ zIndex: 10 }}>
                            ...
                            <Dropdown.Content>
                                <button className="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 transition duration-150 ease-in-out no-drag" onClick={() => setEditing(true)}>
                                    Edit
                                </button>
                                <Dropdown.Link className="no-drag" as="button" href={route('chirps.destroy', chirp.id)} method="delete">
                                    Delete
                                </Dropdown.Link>
                            </Dropdown.Content>
                        </Dropdown>
